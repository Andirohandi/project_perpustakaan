		...
		<div class="col-md-12">
			<div class="box box-info">
                <div class="box-header with-border">
					<h3 class="box-title"><i class='fa fa-book'></i> Data Peminjaman Buku</h3>
                ...
                <div class="box-body">
					...
					<div class='row' style='margin-top:-20px;margin-bottom:10px'>
						...
						<a class='btn btn-success col-xs-12 col-md-4 btn-sm' href="<?php echo site_url('p/peminjaman/add'); ?>"><i class='fa fa-plus'></i> Tambah Peminjaman</a>
							<br/>
						</div>
						<div class='col-sm-3 col-xs-12 pull-right' style='margin-top:5px;margin-bottom:5px'>
							<div class="input-group pull-right">
								<input type="text" name="cari" id='cari' class="form-control input-sm col-sm-4 col-xs-12" placeholder="Cari nomor peminjaman / nama. . ." onchange='pageLoad(1)'>
...
function pageLoad(i){
	...
	$.ajax({
		url		: '<?php echo base_url()?>p/peminjaman/read/'+i,
		type	: 'post',
		dataType: 'html',
...
function hapus(x){
	alertify.confirm("Apakah Anda Yakin Akan Menghapus Data ini ?", function (e) {
		if (e) {
			$.ajax({
				url		: '<?php echo site_url()?>p/peminjaman/hapus',
				type	: 'post',
				dataType: 'json',
				data	: {x:x},
				beforeSend : function(){
